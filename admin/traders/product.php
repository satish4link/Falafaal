	...
	<div class="col-xs-12 col-sm-12 col-md-12 no-padding">
		<div class="traders-list">
			...
			if(isset($_SESSION["traderuserid"])){
				...
				$sql= "SELECT product.product_id, product.product_name, product.product_rate, product.product_image, product.description, shop.shop_name FROM shop, product WHERE product.shop_id = shop.shop_id AND shop.traders_id = '$tid'";
