...
<div class="col-xs-12 col-sm-11 col-md-11">
	...
	<div class="col-xs-12 col-sm-12 col-md-12 no-padding">
		<div class="traders-list">
			<?php
			if(isset($_SESSION["traderuserid"])){
					$tid = $_SESSION["traderuserid"];
				$sql = "SELECT orders.o_id, orders.cust_name, orders.prod_name, orders.price, orders.qty, orders.total, product.product_id FROM orders, product, shop WHERE orders.prod_id = product.product_id AND product.shop_id = shop.shop_id AND shop.traders_id = $tid";
