	...
	<div class="col-xs-12 col-sm-12 col-md-12 no-padding">
		<div class="traders-list">
			<?php
				...
				$sql= "SELECT shop.shop_id, shop.shop_name, shop.shop_image, shop.shop_status, traders.full_name FROM shop, traders WHERE traders.traders_id = shop.traders_id AND traders.traders_id = '$tid'";
